...
@section('content')
<div class="container">
    <form id="form-img" enctype="multipart/form-data" method="POST" action="{{ route('picture.add', $platillo->id) }}" >
        {!! csrf_field() !!}
        <div class="input-group mb-2">
            ...
            <div class="input-group-prepend">
                <input type="hidden" id="sucursal" name="sucursal" value="{{Auth::user()->id}}" >
        ...
        @foreach ($platillo->fotos as $foto)
            <div class="card">
                ...
                <div class="card-body p-0">
                    <form method="POST" action="{{ route('picture.remove', $platillo->id) }}">
                        {!! csrf_field() !!}
