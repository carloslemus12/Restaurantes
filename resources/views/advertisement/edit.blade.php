    ...
    <div class="row w-100">
        <div class="col w-100 mt-4">
            <div class="card bg-transparent border-0">
                ...
                <form id="form-anuncio" method="POST" action="{{url('adm/advertisement/'.$anuncio->id) }}">
                    ...
                    <div class="card-body bg-dark text-white">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="date" class="form-control" id="fecha" name="fecha" value="{{$anuncio->fecha_final}}">
                            </div>                                       
                        </div>
                    </div>
