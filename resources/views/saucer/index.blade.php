        ...
        <div class="col w-100 mt-4">
            <div class="card bg-transparent">
                <div class="card-header">
                    <a class="btn btn-success" href="{{ url('/adm/saucer/create') }}">Registrar platillo</a>
                </div>
                <div class="card-body">
                        ...
                        @foreach ($platillos as $platillo)
                            <tr>
                                ...
                                <td class="text-center d-flex justify-content-around">
                                    <a href="{{ url('adm/saucer/'.$platillo->id) }}"><img src="{{ asset('svg/si-glyph-picture.svg')  }}" style="width:32px;"/></a>
                                    
                                    <a href="{{ url('adm/saucer/'.$platillo->id.'/edit') }}"><img src="{{ asset('svg/si-glyph-edit.svg')  }}" style="width:32px;"/></a>
                                    ...
                                    <form method="POST" action="{{route('saucer.destroy', $platillo->id) }}">
                                        {!! csrf_field() !!}
